...
\educationitem{Carnegie Mellon University}{Pittsburgh, PA}{B.S. Chemistry, Concentration: Computational Chemistry}{May 2016 - Expected}
...
\item Created proof-of-concept applications for high-resolution refinement, ∆∆G prediction, protein-protein docking, assembly of symmetric complexes
\item Building a new implicit membrane model able to capture different membrane lipid compositions
...
\begin{compactitem}
\item Implemented module for a polygon on the surface of an ellipsoid
...
\leadershipitem{Carnegie Mellon Dean's List High Honors}{2014, Spring 2015}{Awarded to students with a semester GPA of 3.7 or higher}
...
\leadershipitem{Intel International Science and Engineering Fair--Best in Biochemistry}{2012}{First place and top category award for Biochemistry category}
